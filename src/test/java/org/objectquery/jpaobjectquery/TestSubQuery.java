...
public class TestSubQuery {
	...
	public void testDoubleSubQuery() {
		...
		Assert.assertEquals(
				"select A from org.objectquery.jpaobjectquery.domain.Person A where A.dud  =  (select AA0 from org.objectquery.jpaobjectquery.domain.Person AA0 where AA0.name  =  A.dog.name AND AA0.mum  =  (select AA0A0 from org.objectquery.jpaobjectquery.domain.Person AA0A0 where AA0A0.mum.name  =  AA0.mum.name AND AA0A0.mum.name  =  A.mum.name))",
				getQueryString(query));
