...
public class TestSimpleQuery {
	...
	public void testBaseCondition() {
		...
		assertEquals("select A from org.objectquery.jpa.domain.Person A where A.name  =  :A_name", JPAObjectQuery.jpqlGenerator(qp).getQuery());
	...
	public void testDupliedPath() {
		...
		assertEquals("select A from org.objectquery.jpa.domain.Person A where A.name  =  :A_name AND A.name  =  :A_name1", JPAObjectQuery.jpqlGenerator(qp)
				.getQuery());
	...
	public void testDottedPath() {
		...
		assertEquals("select A from org.objectquery.jpa.domain.Person A where A.dog.name  =  :A_dog_name AND A.dud.name  =  :A_dud_name", JPAObjectQuery
	...
	public void testProjection() {
		...
		assertEquals("select A.name from org.objectquery.jpa.domain.Person A where A.dog.name  =  :A_dog_name", JPAObjectQuery.jpqlGenerator(qp).getQuery());
	...
	public void testProjectionCountThis() {
		...
		assertEquals("select  COUNT(A) from org.objectquery.jpa.domain.Person A where A.dog.name  =  :A_dog_name", JPAObjectQuery.jpqlGenerator(qp).getQuery());
	...
	public void testSelectOrder() {
		...
		assertEquals("select A from org.objectquery.jpa.domain.Person A where A.dog.name  =  :A_dog_name order by A.name", JPAObjectQuery.jpqlGenerator(qp)
				.getQuery());
	...
	public void testOrderAsc() {
		...
		assertEquals("select A from org.objectquery.jpa.domain.Person A where A.dog.name  =  :A_dog_name order by A.name ASC", JPAObjectQuery.jpqlGenerator(qp)
				.getQuery());
	...
	public void testOrderDesc() {
		...
		assertEquals("select A from org.objectquery.jpa.domain.Person A where A.dog.name  =  :A_dog_name order by A.name DESC,A.dog.name DESC", JPAObjectQuery
				.jpqlGenerator(qp).getQuery());
	...
	public void testOrderGrouping() {
		...
		assertEquals("select A from org.objectquery.jpa.domain.Home A where A.address  =  :A_address group by A  order by  COUNT(A.price) ASC", JPAObjectQuery
				.jpqlGenerator(qp).getQuery());
	...
	public void testOrderGroupingPrj() {
		...
		assertEquals("select A.address, COUNT(A.price) from org.objectquery.jpa.domain.Home A group by A.address order by  COUNT(A.price) ASC", JPAObjectQuery
				.jpqlGenerator(qp).getQuery());
	...
	public void testINCondition() {
		...
		assertEquals("select A from org.objectquery.jpa.domain.Person A where A.name  in  (:A_name) AND A.name  not in  (:A_name1)", JPAObjectQuery
				.jpqlGenerator(qp).getQuery());
	...
	public void testContainsCondition() {
		...
		assertEquals("select A from org.objectquery.jpa.domain.Person A where :A_friends  member of  A.friends AND :A_friends1  not member of  A.friends",
				JPAObjectQuery.jpqlGenerator(qp).getQuery());
	...
	public void testProjectionGroup() {
		...
		assertEquals("select A.address, MAX(A.price) from org.objectquery.jpa.domain.Home A group by A.address order by A.address", JPAObjectQuery
				.jpqlGenerator(qp).getQuery());
	...
	public void testBetweenCondition() {
		...
		assertEquals("select A from org.objectquery.jpa.domain.Home A where A.price  BETWEEN  :A_price AND :A_price1 ", JPAObjectQuery.jpqlGenerator(qp)
				.getQuery());
